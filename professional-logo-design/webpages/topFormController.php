...
# LIST EMAIL ADDRESS
$recipient = "forms@LogoArcLogo.com";
...
$sender = "support@LogoArcLogo.com";

$locationurl="https://LogoArcLogo.com/promotion";
# MAIL BODY
$subscriber_email = $_REQUEST['Email'];
$subscriber_subject = "Thankyou!! One of Our Consultant Will Get Back To you Shortly
";
$subscriber_email_data = file_get_contents('https://LogoArcLogo.com/email/queryFormThankyou.html');
