...
<div class="smallbox">
    ...
    <h4>Illustrative Bronze Logo<br> Package</h4>
  ...
  <div class="smallbox">
    <h2>$199.00 <span><s>$280.00</s></span> </h2>
    <h4>Illustrative Silver Logo<br> Package</h4>
    <p>Suitable for low-level startups and organizations.</p>
    <div class="hrline"></div>
    <!-- <h3>Payable Amount</h3> -->
    <ul class="ticklist2 list-scroll">
...
<div class="smallbox">
    ...
    <h4>Illustrative Gold Logo<br> Package</h4>
