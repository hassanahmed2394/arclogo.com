    ...
    <div class="row">
      <div class="col-lg-12 col-md-12 col-sm-12">
        <div class="cmp-heading-sec">
          <h1>$1,199.99. Yes. That’s all it takes for complete branding at ArcLogo.</h1>
          <p>We have ample experience when it comes to transforming brands and their identities. ArcLogo uses all that into creating a unique brand image for you in packages that are made to suit your needs and budget. </p>  
        </div>
      </div> 
    </div>
    <div class="row">
