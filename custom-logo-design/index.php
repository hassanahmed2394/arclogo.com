...
<section class="hero-services hero-subservices forlogolp forweblp" style=" overflow:hidden;position: relative;">
  ...
  <section class="floating_wrap" style="display: none;">
    ...
    <div class="float_form_box">
      <div class="floating_form">
        ...
        <div class="floating_inner">
          ...
          <div class="form_wrap">
            <form method="POST" action="webpages/bannerFormController.php" id="quoteForm" autocomplete="off">
              <div class="row">
    ...
    <div class=" hero-banner">
      ...
      <div class="container hidecustom hideweb hidelogodesign">
        <div class="d_t">
          <div class="d_c">
            <div class="row">
              ...
              <div class="col-lg-9 col-md-9 col-sm-9 col-md-offset-0 col-sm-offset-2">
                ...
                <h4 class=" sea" >Custom Logo Development</h4>
                <h3 class="" d >Logo: the face for your business!</h3>
                
                <p class="" >Similar to how people are judged by their personalities, companies worldwide are judged by their logo design. Our logo design experienced professionals help businesses worldwide in developing and becoming top quality class figures in their respective competitive industries. We will design you a logo that looks professional in just 3 days and it will make your business look trustworthy and more recognized so you can dominate your rivals.</p>
                <div class="actions">
                  <a href="GetFreeConsultancy" class="btn-line draw floatme btn-line-fill sea-d sea-fill">Discuss Your Idea <i class="fa fa-arrow-right" aria-hidden="true"></i></a></div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="row methodolgy-slider slider">
            <div class="col-md-3 col-lg-3 col-sm-3 col-xs-12 text-center " >
              <div class="process-img">
                <span class="icon-Brand-process-01"></span> </div>
                <h4>Analysis </h4>
              ...
              <div class="col-md-3 col-lg-3 col-sm-3 col-xs-12 text-center " >
                <div class="process-img">
                  <span class="icon-Brand-process-02"></span> </div>
                  <h4>Creation </h4>
                ...
                <div class="col-md-3 col-lg-3 col-sm-3 col-xs-12 text-center " >
                  <div class="process-img">
                    <span class="icon-Brand-process-03"></span> </div>
                    <h4>Momentum </h4>
                  ...
                  <div class="col-md-3 col-lg-3 col-sm-3 col-xs-12 text-center " >
                    <div class="process-img">
                      <span class="icon-Brand-process-04"></span> </div>
                      <h4>Results </h4>
                  ...
                  <div class="actions text-center margin-top-20 wow fadeInDown" >
                    <a onclick="$zopim.livechat.window.toggle()" class="btn-green">Discuss Your Idea</a> <a href="packages" class="btn-line draw">SEE OUR PACKAGES <i class="fa fa-arrow-right"></i> </a></div>
                  </div>
                </div>
              </section>
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-6">
        ...
        <form method="POST" action="webpages/orderFormController.php" id="quoteForm" autocomplete="off">
          <div class="row">
