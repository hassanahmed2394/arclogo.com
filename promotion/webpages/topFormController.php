...
$sender = "support@arclogo.com";

$locationurl="https://arclogo.com/promotion";
# MAIL BODY
$subscriber_email = $_REQUEST['Email'];
$subscriber_subject = "Thankyou!! One of Our Consultant Will Get Back To you Shortly
";
$subscriber_email_data = file_get_contents('https://arclogo.com/email/queryFormThankyou.html');
