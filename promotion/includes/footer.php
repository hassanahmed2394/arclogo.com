                  ...
                  <div class="col-md-7 col-sm-7 col-xs-12 contact-form">
                     <form  id="contactForm"class="jform" action="webpages/bannerFormController.php" method="post">
                        ...
                        <div>
                            ...
                            <div id="contactFormResult" class="alert alert-success" style="font-size: 12px;display: none;">Congratulations! You've Signed up, For Further Assistance Start <a href="javascript:;" onclick="setButtonURL()"> Live Chat.</a></div>
   ...
   $('input[name="cip"]').val(ip);
         ...
         <div class="footer-bottom">
            <div class="container">
               <div class="row">
                  <div class="col-md-12">
                    <p>© Copyright 2019 ArcLogo. All Rights Reserved   <!-- | <a href="<?php echo $basesurl;?>privacy.php">Privacy Policy</a> | <a href="<?php echo $basesurl;?>terms.php">Terms & Conditions</a> --> 
                    </p>
                  </div>
               </div>
            </div>
...
<div class="phone-mobile">
 <a href="tel:19252689288"> <span class="icon-phone"></span></a>
</div>
      ...
      <section id="popupformLead"  class="popup-form">
         <div class="formcontainer">
            ...
            <div id="popupform" class="inform">
               <form  id="PopopForm" class="jform clearfix"  method="post">
                  ...
                  <div class="field phone">
                     <input type="text" id="phone-coun" maxlength="25" minlength="7" name="Number" value="" placeholder="Phone Number" class="required number" required>
                  </div>
                  <div class="field">
                  ...
                  <div class="clearfix fieldwrap text-center pop-btn">
                     ...
                     <!-- <div id="PopopFormResult">
                     
                     </div> -->

                     <div id="PopopFormResult" class="alert alert-success" style="font-size: 12px;display: none;">Congratulations! You've Signed up, For Further Assistance Start <a href="javascript:;" onclick="setButtonURL()"> Live Chat.</a></div>
                     <input type="hidden" name="hiddencapcha">
                      <input type="hidden" name="pc" value="">
                                 <input type="hidden" name="cip" value="">
                                 <input type="hidden" name="ctry" value="">
    ...
    $('#PopopForm').submit(function() {
        ...
        $.ajax({
            ...
            {  console.log(response);
              ...
              $("#PopopFormResult").fadeIn();
              
              $("#PopopForm input[type='text']").val("");
              $("#PopopForm input[type='email']").val("");
              $("#PopopForm input[type='Number']").val("");
              $("#PopopForm input[type='hidden']").val("");
              $("textarea.required.iemsg").val("");
