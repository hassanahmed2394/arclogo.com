...
<html class="no-js hover js--masthead-hidden" lang=en-gb data-js="toggled nav parent">
   <head>
      ...
      <title>Terms and Conditions | ArcLogo</title>
...
<p>In any event, any deposited funds for a project shall not be subject to refund after delivery if the initial design concepts are approved, or a change is requested unless ArcLogo cancels or terminates your Contract for a reason other than your breach or non-performance. </p>
...
<ul>
        <p> <strong>All refund requests will be fulfilled as per the following arrangement:</strong></p>
         ...
         <li>  All refund requests should be communicated to the support department. ArcLogo, based on the violation of your user agreement reserves the right to approve/disapprove your request on an individual case to case basis. </li>
         <li>  For ArcLogo / Custom packages, refund will be applicable the same as it is on the single packages. 
</li>
         ...
         <ul>
          <li>  Claim your refund specifying your concern by contacting us via any of the following three modes:
            <ul>
             ...
             <li>  Live Chat</li>
             <li>  <a href="mailto:support@arclogo.com">support@arclogo.com</a></li>
            </ul>
          </li>  
           <li>  We will try to resolve your concern by virtue of our revision policy immediately or else will email you a refund request approval from our refund department. After the refund, your design rights would be obtained by ArcLogo and you would not be able to display any version of the design sent by company. Let us also specify that:
            <ul>
               ...
               <li>  Working in collaboration with the Government Copyright Agencies ArcLogo would share Copyright Acquisition information for the refunded designs that would restrict the re-use of the designs as original designs in the future.
               
               If you have any questions or concerns about our Refund Policy, please contact us by clicking here <a href="mailto:support@arclogo.com">support@arclogo.com</a>.
               </li>
            </ul>
           </li>
         </ul>
